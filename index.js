    ...
    class TypeScriptParser extends Parser {
      ...
      isRedeclaredInScope(scope, name, bindingType) {
        ...
        if (bindingType & acornScope.BIND_FUNCTION) {
          return scope.lexical.indexOf(name) > -1 || !super.treatFunctionsAsVarInScope(scope) && scope.var.indexOf(name) > -1;
        }
        return scope.lexical.indexOf(name) > -1 && // Annex B.3.4
        // https://tc39.es/ecma262/#sec-variablestatements-in-catch-blocks
        !(scope.flags & acornScope.SCOPE_SIMPLE_CATCH && scope.lexical[0] === name) || !this.treatFunctionsAsVarInScope(scope) && scope.functions.indexOf(name) > -1;
      }
