...
import type { AcornTypeScript } from '../src/types.js';
...
function checkAcornTypeScriptUndefined(acornTypeScript?: AcornTypeScript): boolean {
	...
	return (
		Boolean(acornTypeScript.tokTypes) &&
...
function checkAcornTypeScriptEqual(
	...
	return (
		acornTypeScriptOne.tokTypes === acornTypeScriptTwo.tokTypes &&
		acornTypeScriptOne.keywordsRegExp === acornTypeScriptTwo.keywordsRegExp &&
		acornTypeScriptOne.tokenIsLiteralPropertyName ===
			acornTypeScriptTwo.tokenIsLiteralPropertyName &&
		acornTypeScriptOne.tokenIsKeywordOrIdentifier ===
			acornTypeScriptTwo.tokenIsKeywordOrIdentifier &&
...
describe('static plugin', () => {
	it('acornTypeScript', () => {
		...
		acorn.Parser.extend(tsPlugin() as any, function (BaseParser) {
	...
	it('acornTypeScript in two plugins', () => {
